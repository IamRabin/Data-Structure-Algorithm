...
//
// /**
//  * This function implements Bucket sort algorithm with an array of size n and number of k buckets.
//   */
// void bucket_sort(double* A, const std::size_t n, const std::size_t k) {
//     // allocating empty lsit corresponding to bucket number
//     List<double>* B{new List<double>[k]{}};
//     // appending the elements  of A to the  bucket
//     for (std::size_t i=0; i < n; ++i) {
